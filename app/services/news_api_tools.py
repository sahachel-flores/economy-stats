...
def get_news_articles_from_news_api(query:str, from_date:str, to_date:str, context: AgentContext, db: SessionLocal) -> list[dict]:
    """
    This function gets the news articles from the News API and adds them to the database.
    """

    if not test_db_has_items(db, from_date):
